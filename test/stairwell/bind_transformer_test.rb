...
module Stairwell
  class BindTransformerTest < Minitest::Test
    def test_incorrect_sql_args
      ...
      assert_raises_with_message Stairwell::SqlBindMismatch, ':age in your query is missing from your args' do
        Stairwell::BindTransformer.new(sql, binds).run
      end
    end
    ...
    def test_incorrect_bind_hash_args
      ...
      assert_raises_with_message Stairwell::SqlBindMismatch,
                                 ":age in your bind hash is missing from your query: #{sql}" do
        Stairwell::BindTransformer.new(sql, binds).run
      end
    end
    ...
    def test_quoting_for_all_types
      ...
      assert_match Stairwell::BindTransformer.new(sql, binds).run, expected_result
    end
  end
end
